...
BLOG_AUTHOR = "Kostas Andreadis"  # (translatable)
BLOG_TITLE = "My Personal Work Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://kandread.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "kandread@jpl.nasa.gov"
BLOG_DESCRIPTION = "Blogging about my work projects."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "https-kandread-github-io"
